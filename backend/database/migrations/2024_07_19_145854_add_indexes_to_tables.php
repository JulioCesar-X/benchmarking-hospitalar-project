...
class AddIndexesToTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('sais', function (Blueprint $table) {
            ...
            $table->index('service_id');   // Índice para service_id (adicional para otimização)
        });
    }
    ...
    public function down()
    {
        ...
        Schema::table('sais', function (Blueprint $table) {
            ...
            $table->dropIndex(['service_id']);   // Remove o índice de service_id (adicional para otimização)
        });
    }
}